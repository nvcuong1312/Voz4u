...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Returns the group of libraries at nv
     */
    ...
    public static class HtmlLibraryAccessors extends SubDependencyFactory {
        ...
        public HtmlLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for textview (com.github.sakacyber:html-textview)
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class NvLibraryAccessors extends SubDependencyFactory {
        ...
        public NvLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for textview (org.sufficientlysecure:html-textview)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getTextview() {
                return create("nv.textview");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: htmlTextview (4.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: htmlTextviewVersion (1.0.15)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getHtmlTextviewVersion() { return getVersion("htmlTextviewVersion"); }
            ...
            /**
             * Returns the version associated to this alias: okhttpDnsoverhttps (4.9.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getOkhttpDnsoverhttps() { return getVersion("okhttpDnsoverhttps"); }
